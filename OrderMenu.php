...
<main>
    <aside>
        ...
        <ul>
		<img src = "pepperoni.jpg" alt="pepperoni pizza"  style="width:128px;height:128px;"/>
	...
	<img src = "hawaiian.jpg" alt="hawaiian pizza" style="width:128px;height:128px;"/>
	...
	<img src = "cheese.jpg" alt="cheese pizza" style="width:128px;height:128px;"/>		
            <!-- display links for all categories -->
	<br><form action="Sub Menu.php"
    ...
    <h1>Side Orders</h1>
		...
		<ul>
				<img src = "lasagna.jpg" alt="lasanga" style="width:128px;height:128px;"/>
